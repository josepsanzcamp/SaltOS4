...
function output_handler($array)
{
    ...
    if ($cache) {
        header("Expires: " . gmdate("D, d M Y H:i:s", time() + get_default("cache/cachegctimeout")) . " GMT");
        header("Cache-Control: max-age=" . get_default("cache/cachegctimeout") . ", no-transform");
