...
"use strict";saltos.form=function(t){console.log(arguments.length);var e=saltos.html("<div></div>");for(var a in t){var o=t[a];if(["container","col","row"].includes(a))if("object"==typeof o&&o.hasOwnProperty("value")&&o.hasOwnProperty("#attr"))(l=o["#attr"]).type=a,(s=saltos.form_field(l)).append(saltos.form(o.value,1)),e.append(s);else(l={}).type=a,(s=saltos.form_field(l)).append(saltos.form(o,1)),e.append(s);else if("object"==typeof o&&o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")){(l=o["#attr"]).type=a,l.value=o.value;var s=saltos.form_field(l);e.append(s)}else{var l;(l={}).type=a,l.value=o;s=saltos.form_field(l);e.append(s)}}return 1==e.childNodes.length?e.firstChild:e},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/"+saltos.app+"/default",success:function(t){saltos.action=t.actions.action,saltos.ajax({url:"index.php?getapp/"+saltos.app+"/"+saltos.action,success:function(t){document.querySelector("body").append(saltos.form(t.layout))},headers:{token:saltos.token}})},headers:{token:saltos.token}});
