...
"use strict";saltos.show_error=function(o){var t;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/>Code "+o.code,footer:(t=saltos.html("<div></div>"),t.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),t)})},saltos.form_layout=function(o){var t=[];for(var e in o){var r=o[e];if(e=saltos.fix_key(e),["container","col","row","div"].includes(e))if("object"==typeof r&&r.hasOwnProperty("value")&&r.hasOwnProperty("#attr")){(n=r["#attr"]).type=e;var a=saltos.form_field(n),s=saltos.form_layout(r.value,1);for(var l in s)a.append(s[l]);t.push(a)}else{(n={}).type=e;a=saltos.form_field(n),s=saltos.form_layout(r,1);for(var l in s)a.append(s[l]);t.push(a)}else if("object"==typeof r&&r.hasOwnProperty("value")&&r.hasOwnProperty("#attr")){(n=r["#attr"]).type=e,n.value=r.value,n.hasOwnProperty("onclick")&&"string"==typeof n.onclick&&(n.onclick=new Function(n.onclick));a=saltos.form_field(n);t.push(a)}else{var n;(n={}).type=e,n.value=r;a=saltos.form_field(n);t.push(a)}}if(2==arguments.length)return t;var i=saltos.html("<div></div>");for(var l in t)i.append(t[l]);return 1==i.childNodes.length?i.firstChild:i},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/"+saltos.app+"/default",success:function(o){"object"!=typeof o.error?void 0!==o.layout?document.querySelector("body").append(saltos.form_layout(o.layout)):saltos.show_error({text:"Internal error",code:"app/124"}):saltos.show_error(o.error)},headers:{token:saltos.token}});
