...
"use strict";saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/"+saltos.app+"/default",success:function(o){saltos.action=o.actions.action,saltos.ajax({url:"index.php?getapp/"+saltos.app+"/"+saltos.action,success:function(o){console.log(o),console.log(saltos.limpiar_key("hola#1")),console.log(saltos.limpiar_key(["hola","hola#1","hola#2"]))},headers:{token:saltos.token}})},headers:{token:saltos.token}});
