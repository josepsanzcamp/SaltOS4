...
"use strict";saltos.form=function(o){for(var s in o){var t=o[s];console.log("**********"),console.log(s),console.log(t),"object"==typeof t&&saltos.form(t)}},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/"+saltos.app+"/default",success:function(o){saltos.action=o.actions.action,saltos.ajax({url:"index.php?getapp/"+saltos.app+"/"+saltos.action,success:function(o){saltos.form(o.layout)},headers:{token:saltos.token}})},headers:{token:saltos.token}});
