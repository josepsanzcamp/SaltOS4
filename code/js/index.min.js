...
"use strict";saltos.show_error=function(o){var t;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/><br/>Code "+o.code,footer:(t=saltos.html("<div></div>"),t.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),t)})},saltos.form_layout=function(o){var t=[];for(var e in o){var s=o[e];if(e=saltos.fix_key(e),["container","col","row","div"].includes(e))if("object"==typeof s&&s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")){(n=s["#attr"]).type=e;var a=saltos.form_field(n),r=saltos.form_layout(s.value,1);for(var l in r)a.append(r[l]);t.push(a)}else{(n={}).type=e;a=saltos.form_field(n),r=saltos.form_layout(s,1);for(var l in r)a.append(r[l]);t.push(a)}else if("object"==typeof s&&s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")){(n=s["#attr"]).type=e,n.value=s.value,n.hasOwnProperty("onclick")&&"string"==typeof n.onclick&&(n.onclick=new Function(n.onclick));a=saltos.form_field(n);t.push(a)}else{var n;(n={}).type=e,n.value=s;a=saltos.form_field(n);t.push(a)}}if(2==arguments.length)return t;var i=saltos.html("<div></div>");for(var l in t)i.append(t[l]);return 1==i.childNodes.length?i.firstChild:i},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/"+saltos.app+"/default",success:function(o){"object"!=typeof o.error?(saltos.action=o.actions.action,saltos.ajax({url:"index.php?getapp/"+saltos.app+"/"+saltos.action,success:function(o){"object"!=typeof o.error?document.querySelector("body").append(saltos.form_layout(o.layout)):saltos.show_error(o.error)},headers:{token:saltos.token}})):saltos.show_error(o.error)},headers:{token:saltos.token}});
