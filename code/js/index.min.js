...
"use strict";saltos.show_error=function(o){var s;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/>Code "+o.code,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),s)})},saltos.send_request=function(o){saltos.ajax({url:"index.php?"+o,success:function(o){"object"==typeof o.error?saltos.show_error(o.error):saltos.process_response(o)}})},saltos.process_response=function(o){for(var s in o){var t=o[s];s=saltos.fix_key(s);if("function"!=typeof saltos.form[s])return console.log("type "+s+" not found"),void document.body.append(saltos.html("type "+s+" not found"));saltos.form[s](t)}},saltos.form={},saltos.form.source=function(o){saltos.send_request(o)},saltos.form.data=function(o){for(var s in o){var t=o[s],e=document.getElementById(s);null!==e&&("checkbox"==e.type?e.checked=!!t:e.value=t)}},saltos.form.layout=function(o){if(o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")){var s=o["#attr"],t=o.value;if(saltos.check_params(s,["auto","cols_per_row","container_class","row_class","col_class"]),""==s.cols_per_row&&(s.cols_per_row=1/0),"true"==s.auto){var e=[];for(var a in t)e.push([a,t[a]]);o={container:{value:{},"#attr":{class:s.container_class}}};for(var r=0,l=0,n=1;e.length;){var c=e.shift(e);n&&(r++,o.container.value["row#"+r]={value:{},"#attr":{class:s.row_class}}),l++,o.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:s.col_class}},o.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=s.cols_per_row?(l=0,n=1):n=0}}else o=t}var i=[];for(var a in o){var u=o[a];if(a=saltos.fix_key(a),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))s=u["#attr"],t=u.value;else s={},t=u;if(s.type=a,s.value=t,["container","col","row","div"].includes(a)){var f=saltos.form_field(s);e=saltos.form.layout(t,1);for(var p in e)f.append(e[p]);i.push(f)}else{s.hasOwnProperty("onclick")&&"string"==typeof s.onclick&&(s.onclick=new Function(s.onclick));f=saltos.form_field(s);i.push(f)}}if(2==arguments.length)return i;var d=saltos.html("<div></div>");for(var p in i)d.append(i[p]);1==d.childNodes.length&&(d=d.firstChild),document.body.append(d)},saltos.form.style=function(o){for(var s in o){var t=o[s];"inline"==(s=saltos.fix_key(s))&&document.body.append(saltos.html(`<style>${t}</style>`)),"file"==s&&document.body.append(saltos.html(`<link href="${t}" rel="stylesheet">`))}},saltos.form.javascript=function(o){for(var s in o){var t,e=o[s];if("inline"==(s=saltos.fix_key(s)))(t=document.createElement("script")).innerHTML=e,document.body.append(t);if("file"==s)(t=document.createElement("script")).src=e,document.body.append(t)}},saltos.hash=document.location.hash,"#"==saltos.hash.substr(0,1)&&(saltos.hash=saltos.hash.substr(1)),""==saltos.hash&&(saltos.hash="app/menu"),saltos.send_request(saltos.hash);
