...
"use strict";null===localStorage.getItem("token")&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/login/default",success:function(e){console.log(e)},headers:{token:"0123456789"}});
