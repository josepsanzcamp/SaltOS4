...
"use strict";saltos.show_error=function(o){var e;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/>Code "+o.code,footer:(e=saltos.html("<div></div>"),e.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),e)})},saltos.send_request=function(o){saltos.ajax({url:"index.php?"+o,success:function(o){"object"==typeof o.error?saltos.show_error(o.error):saltos.process_response(o)}})},saltos.process_response=function(o){for(var e in o){var s=o[e];e=saltos.fix_key(e);if("function"!=typeof saltos.form[e])return console.log("type "+e+" not found"),void document.body.append(saltos.html("type "+e+" not found"));saltos.form[e](s)}},saltos.form={},saltos.form.source=function(o){saltos.send_request(o)},saltos.form.data=function(o){for(var e in o){var s=o[e],t=document.getElementById(e);null!==t&&("checkbox"==t.type?t.checked=!!s:t.value=s)}},saltos.form.layout=function(o){if(o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")){var e=o["#attr"],s=o.value;if(saltos.check_params(e,["auto","cols_per_row","container_class","row_class","col_class"]),""==e.cols_per_row&&(e.cols_per_row=1/0),"true"==e.auto){var t=[];for(var a in s)t.push([a,s[a]]);o={container:{value:{},"#attr":{class:e.container_class}}};for(var r=0,l=0,n=1;t.length;){var c=t.shift(t);n&&(r++,o.container.value["row#"+r]={value:{},"#attr":{class:e.row_class}}),l++,o.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:e.col_class}},o.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=e.cols_per_row?(l=0,n=1):n=0}}else o=s}var i=[];for(var a in o){var u=o[a];if(a=saltos.fix_key(a),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))e=u["#attr"],s=u.value;else e={},s=u;if(e.type=a,e.value=s,["container","col","row","div"].includes(a)){var f=saltos.form_field(e);t=saltos.form.layout(s,1);for(var d in t)f.append(t[d]);i.push(f)}else{f=saltos.form_field(e);i.push(f)}}if(2==arguments.length)return i;var p=saltos.html("<div></div>");for(var d in i)p.append(i[d]);1==p.childNodes.length&&(p=p.firstChild),document.body.append(p)},saltos.form.style=function(o){for(var e in o){var s=o[e];"inline"==(e=saltos.fix_key(e))&&document.body.append(saltos.html(`<style>${s}</style>`)),"file"==e&&document.body.append(saltos.html(`<link href="${s}" rel="stylesheet">`))}},saltos.form.javascript=function(o){for(var e in o){var s,t=o[e];if("inline"==(e=saltos.fix_key(e)))(s=document.createElement("script")).innerHTML=t,document.body.append(s);if("file"==e)(s=document.createElement("script")).src=t,document.body.append(s)}},window.onhashchange=function(o){var e=document.location.hash;"#"==e.substr(0,1)&&(e=e.substr(1)),""==e&&(e="app/menu",history.replaceState(null,null,".#"+e)),document.body.innerHTML="",saltos.send_request(e)},window.dispatchEvent(new HashChangeEvent("hashchange"));
