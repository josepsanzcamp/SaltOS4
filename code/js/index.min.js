...
"use strict";saltos.show_error=function(o){var e;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/>Code "+o.code,footer:(e=saltos.html("<div></div>"),e.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),e)})},saltos.send_request=function(o){saltos.ajax({url:"index.php?"+o,success:function(o){"object"==typeof o?"object"==typeof o.error?saltos.show_error(o.error):saltos.process_response(o):saltos.show_error({text:o,code:0})},headers:{token:saltos.token}})},saltos.process_response=function(o){for(var e in o){var t=o[e];e=saltos.fix_key(e);if("function"!=typeof saltos.form[e])return console.log("type "+e+" not found"),void document.body.append(saltos.html("type "+e+" not found"));saltos.form[e](t)}},saltos.form={},saltos.form.source=function(o){saltos.send_request(o)},saltos.form.data=function(o){for(var e in o){var t=o[e],s=document.getElementById(e);null!==s&&("checkbox"==s.type?s.checked=!!t:s.value=t)}},saltos.form.layout=function(o){if(o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")){var e=o["#attr"],t=o.value;if(saltos.check_params(e,["auto","cols_per_row","container_class","row_class","col_class"]),""==e.cols_per_row&&(e.cols_per_row=1/0),"true"==e.auto){var s=[];for(var a in t)s.push([a,t[a]]);o={container:{value:{},"#attr":{class:e.container_class}}};for(var r=0,l=0,n=1;s.length;){var c=s.shift(s);n&&(r++,o.container.value["row#"+r]={value:{},"#attr":{class:e.row_class}}),l++;var i=e.col_class;c[1]["#attr"].hasOwnProperty("col_class")&&(i=c[1]["#attr"].col_class),o.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:i}},o.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=e.cols_per_row?(l=0,n=1):n=0}}else o=t}var u=[];for(var a in o){var f=o[a];if(a=saltos.fix_key(a),"object"==typeof f&&f.hasOwnProperty("value")&&f.hasOwnProperty("#attr"))e=f["#attr"],t=f.value;else e={},t=f;if(e.type=a,e.value=t,["container","col","row","div"].includes(a)){var d=saltos.form_field(e);s=saltos.form.layout(t,1);for(var p in s)d.append(s[p]);u.push(d)}else{d=saltos.form_field(e);u.push(d)}}if(2==arguments.length)return u;var v=saltos.html("<div></div>");for(var p in u)v.append(u[p]);1==v.childNodes.length&&(v=v.firstChild),document.body.append(v)},saltos.form.style=function(o){for(var e in o){var t=o[e];"inline"==(e=saltos.fix_key(e))&&document.body.append(saltos.html(`<style>${t}</style>`)),"file"==e&&document.body.append(saltos.html(`<link href="${t}" rel="stylesheet">`))}},saltos.form.javascript=function(o){for(var e in o){var t,s=o[e];if("inline"==(e=saltos.fix_key(e)))(t=document.createElement("script")).innerHTML=s,document.body.append(t);if("file"==e)(t=document.createElement("script")).src=s,document.body.append(t)}},window.onhashchange=function(o){var e=document.location.hash;"#"==e.substr(0,1)&&(e=e.substr(1)),""==e&&(e="app/menu",history.replaceState(null,null,".#"+e)),saltos.modal("close"),saltos.offcanvas("close"),document.body.innerHTML="",saltos.send_request(e)},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.token="e9f3ebd0-8e73-e4c4-0ebd-7056cf0e70fe"),window.dispatchEvent(new HashChangeEvent("hashchange"));
