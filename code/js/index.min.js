...
"use strict";saltos.show_error=function(o){var a;saltos.modal({title:"Error",close:"Cerrar",body:o.text+"<br/>Code "+o.code,footer:(a=saltos.html("<div></div>"),a.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),a)})},saltos.form_layout=function(o){if(o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")){var a=o["#attr"],r=o.value;if(saltos.check_params(a,["auto","cols_per_row","container_class","row_class","col_class"]),""==a.cols_per_row&&(a.cols_per_row=1/0),"true"==a.auto){var s=[];for(var t in r)s.push([t,r[t]]);o={container:{value:{},"#attr":{class:a.container_class}}};for(var l=0,e=0,c=1;s.length;){var n=s.shift(s);c&&(l++,o.container.value["row#"+l]={value:{},"#attr":{class:a.row_class}}),e++,o.container.value["row#"+l].value["col#"+e]={value:{},"#attr":{class:a.col_class}},o.container.value["row#"+l].value["col#"+e].value[n[0]]=n[1],e>=a.cols_per_row?(e=0,c=1):c=0}}else o=r}var i=[];for(var t in o){var u=o[t];if(t=saltos.fix_key(t),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))a=u["#attr"],r=u.value;else a={},r=u;if(a.type=t,a.value=r,["container","col","row","div"].includes(t)){var h=saltos.form_field(a);s=saltos.form_layout(r,1);for(var v in s)h.append(s[v]);i.push(h)}else{a.hasOwnProperty("onclick")&&"string"==typeof a.onclick&&(a.onclick=new Function(a.onclick));h=saltos.form_field(a);i.push(h)}}if(2==arguments.length)return i;var p=saltos.html("<div></div>");for(var v in i)p.append(i[v]);return 1==p.childNodes.length?p.firstChild:p},saltos.hash=document.location.hash,"#"==saltos.hash.substr(0,1)&&(saltos.hash=saltos.hash.substr(1)),""!=saltos.hash&&saltos.ajax({url:"index.php?"+saltos.hash,success:function(o){"object"!=typeof o.error?void 0!==o.layout?document.querySelector("body").append(saltos.form_layout(o.layout)):saltos.show_error({text:"Internal error",code:"app/124"}):saltos.show_error(o.error)}});
