...
"use strict";saltos.show_error=function(s){var o;saltos.modal({title:"Error",close:"Cerrar",body:s.text+"<br/>Code "+s.code,footer:(o=saltos.html("<div></div>"),o.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),o)})},saltos.send_request=function(s){saltos.ajax({url:"index.php?"+s,success:function(s){"object"==typeof s.error?saltos.show_error(s.error):saltos.process_response(s)}})},saltos.process_response=function(s){for(var o in s){var a=s[o];"layout"==(o=saltos.fix_key(o))&&document.body.append(saltos.form_layout(a)),"data"==o&&saltos.form_data(a),"style"==o&&saltos.form_style(a),"javascript"==o&&saltos.form_javascript(a)}},saltos.form_data=function(s){for(var o in s){var a=s[o],t=document.getElementById(o);null!==t&&("checkbox"==t.type?t.checked=!!a:t.value=a)}},saltos.form_layout=function(s){if(s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")){var o=s["#attr"],a=s.value;if(saltos.check_params(o,["auto","cols_per_row","container_class","row_class","col_class"]),""==o.cols_per_row&&(o.cols_per_row=1/0),"true"==o.auto){var t=[];for(var e in a)t.push([e,a[e]]);s={container:{value:{},"#attr":{class:o.container_class}}};for(var r=0,l=0,n=1;t.length;){var c=t.shift(t);n&&(r++,s.container.value["row#"+r]={value:{},"#attr":{class:o.row_class}}),l++,s.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:o.col_class}},s.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=o.cols_per_row?(l=0,n=1):n=0}}else s=a}var i=[];for(var e in s){var u=s[e];if(e=saltos.fix_key(e),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))o=u["#attr"],a=u.value;else o={},a=u;if(o.type=e,o.value=a,["container","col","row","div"].includes(e)){var f=saltos.form_field(o);t=saltos.form_layout(a,1);for(var p in t)f.append(t[p]);i.push(f)}else{o.hasOwnProperty("onclick")&&"string"==typeof o.onclick&&(o.onclick=new Function(o.onclick));f=saltos.form_field(o);i.push(f)}}if(2==arguments.length)return i;var d=saltos.html("<div></div>");for(var p in i)d.append(i[p]);return 1==d.childNodes.length?d.firstChild:d},saltos.form_style=function(s){for(var o in s){var a=s[o];"inline"==(o=saltos.fix_key(o))&&document.body.append(saltos.html(`<style>${a}</style>`)),"file"==o&&document.body.append(saltos.html(`<link href="${a}" rel="stylesheet">`))}},saltos.form_javascript=function(s){for(var o in s){var a,t=s[o];if("inline"==(o=saltos.fix_key(o)))(a=document.createElement("script")).innerHTML=t,document.body.append(a);if("file"==o)(a=document.createElement("script")).src=t,document.body.append(a)}},saltos.hash=document.location.hash,"#"==saltos.hash.substr(0,1)&&(saltos.hash=saltos.hash.substr(1)),""==saltos.hash&&(saltos.hash="app/menu"),saltos.send_request(saltos.hash);
