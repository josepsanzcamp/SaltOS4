...
"use strict";saltos.show_error=e=>{var s;(console.log(e),"object"==typeof e)?saltos.modal({title:"Error "+e.code,close:"Close",body:e.text,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Accept",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),s)}):document.body.append(saltos.html(`<pre class="m-3">${e}</pre>`))},saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{"object"==typeof e?"object"!=typeof e.error?saltos.process_response(e):saltos.show_error(e.error):saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.process_response=e=>{for(var s in e){var o=e[s];s=saltos.fix_key(s);"function"==typeof saltos.form[s]?saltos.form[s](o):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form={},saltos.form.data=e=>{for(var s in e){var o=e[s],t=document.getElementById(s);null!==t&&("checkbox"==t.type?t.checked=!!o:t.value=o)}},saltos.form.layout=(e,s)=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var o=e["#attr"],t=e.value;if(saltos.check_params(o,["auto","cols_per_row","container_class","row_class","col_class"]),""==o.cols_per_row&&(o.cols_per_row=1/0),"true"==o.auto){var a=[];for(var r in t)a.push([r,t[r]]);e={container:{value:{},"#attr":{class:o.container_class}}};for(var l=0,n=0,c=1;a.length;){var i=a.shift(a);c&&(l++,e.container.value["row#"+l]={value:{},"#attr":{class:o.row_class}}),n++;var d=o.col_class;i[1].hasOwnProperty("#attr")&&i[1]["#attr"].hasOwnProperty("col_class")&&(d=i[1]["#attr"].col_class),e.container.value["row#"+l].value["col#"+n]={value:{},"#attr":{class:d}},e.container.value["row#"+l].value["col#"+n].value[i[0]]=i[1],n>=o.cols_per_row?(n=0,c=1):c=0}}else e=t}var p=[];for(var r in e){var u=e[r];if(r=saltos.fix_key(r),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))o=u["#attr"],t=u.value;else o={},t=u;if(o.hasOwnProperty("type")||(o.type=r),o.hasOwnProperty("value")||(o.value=t),["container","col","row","div"].includes(r)){var v=saltos.form_field(o);a=saltos.form.layout(t,1);for(var f in a)v.append(a[f]);p.push(v)}else{if(saltos.check_params(o,["id","source"]),""!=o.source){""==o.id&&(o.id=saltos.uniqid());v=saltos.__placeholder_helper(o.id);saltos.__source_helper(o)}else{saltos.__value_helper(o);v=saltos.form_field(o)}p.push(v)}}if(s)return p;var h=saltos.html("<div></div>");for(var f in p)h.append(p[f]);h=saltos.optimize(h),document.body.append(h)},saltos.form.style=e=>{for(var s in e){var o=e[s];"inline"==(s=saltos.fix_key(s))&&document.body.append(saltos.html(`<style>${o}</style>`)),"file"==s&&document.body.append(saltos.html(`<link href="${o}" rel="stylesheet">`))}},saltos.form.javascript=e=>{for(var s in e){var o,t=e[s];if("inline"==(s=saltos.fix_key(s)))(o=document.createElement("script")).innerHTML=t,document.body.append(o);if("file"==s)(o=document.createElement("script")).src=t,document.body.append(o)}},window.onhashchange=e=>{var s=document.location.hash;"#"==s.substr(0,1)&&(s=s.substr(1)),""==s&&(s="app/menu",history.replaceState(null,null,".#"+s)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(1),saltos.send_request(s)},saltos.loading=e=>{var s=document.getElementById("loading");if(e&&!s)return document.body.append(saltos.html('\n            <div id="loading" class="d-flex justify-content-center align-items-center vh-100">\n                <div class="spinner-border" role="status">\n                    <span class="visually-hidden">Loading...</span>\n                </div>\n            </div>\n        ')),window.scrollTo(0,window.scrollMaxY),!0;if(!e&&s){window.scrollTo(0,0);var o=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(o))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","type","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:s=>{if("object"==typeof s)if("object"!=typeof s.error){for(var o in e.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)e[o]=s[o];document.getElementById(e.id).replaceWith(saltos.__form_field[e.type](e))}else saltos.show_error(s.error);else saltos.show_error(s)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.__value_helper=e=>{if(saltos.check_params(e,["value"]),""!=e.value&&"object"==typeof e.value)for(var s in e.value)e[s]=e.value[s]},saltos.token=localStorage.getItem("token"),null===saltos.token&&(saltos.token="e9f3ebd0-8e73-e4c4-0ebd-7056cf0e70fe"),window.dispatchEvent(new HashChangeEvent("hashchange"));
