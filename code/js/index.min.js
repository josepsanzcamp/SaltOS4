...
"use strict";saltos.show_error=function(s){var o;saltos.modal({title:"Error",close:"Cerrar",body:s.text+"<br/>Code "+s.code,footer:(o=saltos.html("<div></div>"),o.append(saltos.form_field({type:"button",value:"Aceptar",class:"btn-primary",onclick:function(){saltos.modal("close")}})),o)})},saltos.send_request=function(s){saltos.ajax({url:"index.php?"+s,success:function(s){"object"==typeof s.error?saltos.show_error(s.error):saltos.process_response(s)}})},saltos.process_response=function(s){for(var o in s){var a=s[o];"layout"==(o=saltos.fix_key(o))&&document.querySelector("body").append(saltos.form_layout(a)),"data"==o&&saltos.form_data(a)}},saltos.form_data=function(s){for(var o in s){var a=s[o],r=document.getElementById(o);null!==r&&("checkbox"==r.type?r.checked=!!a:r.value=a)}},saltos.form_layout=function(s){if(s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")){var o=s["#attr"],a=s.value;if(saltos.check_params(o,["auto","cols_per_row","container_class","row_class","col_class"]),""==o.cols_per_row&&(o.cols_per_row=1/0),"true"==o.auto){var r=[];for(var t in a)r.push([t,a[t]]);s={container:{value:{},"#attr":{class:o.container_class}}};for(var e=0,l=0,n=1;r.length;){var c=r.shift(r);n&&(e++,s.container.value["row#"+e]={value:{},"#attr":{class:o.row_class}}),l++,s.container.value["row#"+e].value["col#"+l]={value:{},"#attr":{class:o.col_class}},s.container.value["row#"+e].value["col#"+l].value[c[0]]=c[1],l>=o.cols_per_row?(l=0,n=1):n=0}}else s=a}var i=[];for(var t in s){var u=s[t];if(t=saltos.fix_key(t),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))o=u["#attr"],a=u.value;else o={},a=u;if(o.type=t,o.value=a,["container","col","row","div"].includes(t)){var f=saltos.form_field(o);r=saltos.form_layout(a,1);for(var h in r)f.append(r[h]);i.push(f)}else{o.hasOwnProperty("onclick")&&"string"==typeof o.onclick&&(o.onclick=new Function(o.onclick));f=saltos.form_field(o);i.push(f)}}if(2==arguments.length)return i;var v=saltos.html("<div></div>");for(var h in i)v.append(i[h]);return 1==v.childNodes.length?v.firstChild:v},saltos.hash=document.location.hash,"#"==saltos.hash.substr(0,1)&&(saltos.hash=saltos.hash.substr(1)),""==saltos.hash&&(saltos.hash="app/menu"),saltos.send_request(saltos.hash);
