"use strict";var saltos=saltos||{};saltos.init_error=function(){window.onerror=function(e,t,s,r,o){if(!isset(o)||!isset(o.stack))o={stack:"unknown"};var n={action:"adderror",jserror:e,details:"Error on file "+t+":"+s+":"+r+", userAgent is "+navigator.userAgent,backtrace:o.stack};saltos.ajax({url:"index.php",data:JSON.stringify(n),type:"post"})}},saltos.addlog=function(e){var t={action:"addlog",msg:e};saltos.ajax({url:"index.php",data:JSON.stringify(t),type:"post"})},saltos.check_params=function(e,t,s){for(var r in isset(s)||(s=""),t)isset(e[t[r]])||(e[t[r]]=s)},saltos.uniqid=function(){return"id"+Math.floor(1e6*Math.random())},saltos.when_visible=function(e,t,s){e.getAttribute("id")||e.setAttribute("id","fix"+saltos.uniqid());var r=e.getAttribute("id"),o=setInterval((function(){var e=document.getElementById(r);null===e?(clearInterval(o),console.log("#"+r+" not found")):null!==e.offsetParent&&(clearInterval(o),t(s))}),100)},saltos.get_keycode=function(e){return e.keyCode?e.keyCode:e.which?e.which:e.charCode},saltos.html=function(){var e="div",t="";1==arguments.length&&(t=arguments[0]),2==arguments.length&&(e=arguments[0],t=arguments[1]);var s=document.createElement(e);return s.innerHTML=t.trim(),1==s.childNodes.length?s.firstChild:s},saltos.ajax=function(e){if(saltos.check_params(e,["url","data","method","success","error","progress","async","headers"]),e.method=e.method.toUpperCase(),""==e.method&&(e.method="GET"),""===e.async&&(e.async=!0),""==e.headers&&(e.headers={}),!["GET","POST"].includes(e.method))return console.log("unknown "+e.method+" type"),null;var t=new XMLHttpRequest;for(var s in t.onreadystatechange=function(){if(4==t.readyState)if(200==t.status){if("function"==typeof e.success){var s=t.response;t.getResponseHeader("content-type").toUpperCase().includes("JSON")&&(s=JSON.parse(t.responseText)),t.getResponseHeader("content-type").toUpperCase().includes("XML")&&(s=t.responseXML),e.success(s,t.statusText,t)}}else"function"==typeof e.error&&e.error(t,t.status,t)},"function"==typeof e.progress&&(t.onprogress=e.progress,t.upload.onprogress=e.progress),t.open(e.method,e.url,e.async),e.headers)t.setRequestHeader(s,e.headers[s]);return t.send(e.data),t},saltos.init_error();
...
"use strict";null===localStorage.getItem("token")&&(saltos.app="login"),saltos.ajax({url:"index.php?getapp/login/default",type:"get",success:function(e){console.log(e)},headers:{token:"0123456789"}});
