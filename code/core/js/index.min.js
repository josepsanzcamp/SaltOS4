...
"use strict";saltos.show_error=t=>{var s;(console.log(t),"object"==typeof t)?saltos.modal({title:"Error "+t.code,close:"Close",body:t.text,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),s)}):document.body.append(saltos.html(`<pre class='m-3'>${t}</pre>`))},saltos.check_response=t=>"object"!=typeof t?(saltos.show_error(t),!1):"object"!=typeof t.error||(saltos.show_error(t.error),!1),saltos.send_request=t=>{saltos.ajax({url:"index.php?"+t,success:t=>{saltos.check_response(t)&&saltos.process_response(t)},error:t=>{saltos.show_error({text:t.statusText,code:t.status})},headers:{token:saltos.token.get_token()}})},saltos.process_response=t=>{for(var s in t){var e=t[s];s=saltos.fix_key(s),"function"==typeof saltos.form_app[s]?saltos.form_app[s](e):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=t=>{for(var s in t){var e=t[s],o=document.getElementById(s);null!==o&&("checkbox"==o.type?o.checked=!!e:o.value=e)}},saltos.form_app.layout=(t,s)=>{t=saltos.form_app.__layout_auto_helper(t);var e=[];for(var o in t){var a=t[o];o=saltos.fix_key(o);var r={},l=a;if("object"==typeof a&&a.hasOwnProperty("value")&&a.hasOwnProperty("#attr")&&(r=a["#attr"],l=a.value),r.hasOwnProperty("type")||(r.type=o),"layout"==o){var n=saltos.form_app.layout({value:l,"#attr":r},"div");e.push(n)}else if(["container","col","row","div"].includes(o)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var p in c)n.append(c[p]);e.push(n)}else{if("object"==typeof l)for(var i in l)r.hasOwnProperty(i)||(r[i]=l[i]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);e.push(n)}}if("arr"==s)return e;var u=saltos.html("<div></div>");for(var p in e)u.append(e[p]);if(u=saltos.optimize(u),"div"==s)return u;document.body.append(u)},saltos.form_app.__layout_auto_helper=t=>{if(t.hasOwnProperty("value")&&t.hasOwnProperty("#attr")){var s=t["#attr"],e=t.value;if(saltos.check_params(s,["auto","cols_per_row"]),saltos.check_params(s,["container_class","row_class","col_class"]),saltos.check_params(s,["container_style","row_style","col_style"]),""==s.cols_per_row&&(s.cols_per_row=1/0),"true"==s.auto){var o=[];for(var a in e)o.push([a,e[a]]);t={container:{value:{},"#attr":{class:s.container_class,style:s.container_style}}};for(var r=0,l=0,n=1;o.length;){var c=o.shift();n&&(r++,t.container.value["row#"+r]={value:{},"#attr":{class:s.row_class,style:s.row_style}}),l++;var p=s.col_class,i=s.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(p=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(i=c[1]["#attr"].col_style)),t.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:p,style:i}},t.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=s.cols_per_row?(l=0,n=1):n=0}}else t=e}return t},saltos.form_app.style=t=>{for(var s in t){var e=t[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("style");o.innerHTML=e,document.head.append(o)}"file"==s&&saltos.require(e)}},saltos.form_app.javascript=t=>{for(var s in t){var e=t[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("script");o.innerHTML=e,document.body.append(o)}"file"==s&&saltos.require(e)}},window.onhashchange=t=>{var s=document.location.hash;"#"==s.substr(0,1)&&(s=s.substr(1)),""==s&&(s="app/menu",history.replaceState(null,null,".#"+s)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(!0),saltos.send_request(s)},saltos.loading=t=>{var s=document.getElementById("loading");if(t&&!s)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,1<<30),!0;if(!t&&s){window.scrollTo(0,0);var e=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(e))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=t=>{saltos.check_params(t,["id","source"]),""!=t.source&&saltos.ajax({url:"index.php?"+t.source,success:s=>{if(saltos.check_response(s)){for(var e in t.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)t[e]=s[e];document.getElementById(t.id).replaceWith(saltos.form_field(t))}},error:t=>{saltos.show_error({text:t.statusText,code:t.status})},headers:{token:saltos.token.get_token()}})},saltos.get_data=t=>{for(var s in saltos.__form_app.data={},saltos.__form_app.fields){var e=saltos.__form_app.fields[s],o=document.getElementById(e.id);if(null!==o&&["hidden","text","password","checkbox","textarea"].includes(o.type)){var a=o.value;(e.value!=a||t)&&(saltos.__form_app.data[e.id]=a)}}return saltos.__form_app.data},saltos.token={},saltos.token.get_token=()=>localStorage.getItem("saltos.token"),saltos.token.get_expires=()=>localStorage.getItem("saltos.expires"),saltos.token.set=(t,s)=>{localStorage.setItem("saltos.token",t),localStorage.setItem("saltos.expires",s)},saltos.token.unset=()=>{localStorage.removeItem("saltos.token"),localStorage.removeItem("saltos.expires")},saltos.authenticate={},saltos.authenticate.authtoken=(t,s)=>{saltos.ajax({url:"index.php",data:JSON.stringify({user:t,pass:s,action:"authtoken"}),method:"post",content_type:"application/json",async:!1,success:t=>{saltos.check_response(t)&&("ok"!=t.status?"ko"!=t.status?saltos.show_error(t):saltos.token.unset():saltos.token.set(t.token,t.expires_at))},error:t=>{saltos.show_error({text:t.statusText,code:t.status})}})},saltos.authenticate.reauthtoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"reauthtoken"}),method:"post",content_type:"application/json",async:!1,success:t=>{saltos.check_response(t)&&("ok"!=t.status?"ko"!=t.status?saltos.show_error(t):saltos.token.unset():saltos.token.set(t.token,t.expires_at))},error:t=>{saltos.show_error({text:t.statusText,code:t.status})},headers:{token:saltos.token.get_token()}})},saltos.authenticate.deauthtoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"deauthtoken"}),method:"post",content_type:"application/json",async:!1,success:t=>{saltos.check_response(t)&&("ok"!=t.status&&"ko"!=t.status?saltos.show_error(t):saltos.token.unset())},error:t=>{saltos.show_error({text:t.statusText,code:t.status})},headers:{token:saltos.token.get_token()}})},saltos.authenticate.checktoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"checktoken"}),method:"post",content_type:"application/json",async:!1,success:t=>{saltos.check_response(t)&&("ok"==t.status&&t.token?saltos.token.set(t.token,t.expires_at):"ko"!=t.status?saltos.show_error(t):saltos.token.unset())},error:t=>{saltos.show_error({text:t.statusText,code:t.status})},headers:{token:saltos.token.get_token()}})},(()=>{var t=window.matchMedia("(prefers-color-scheme: dark)"),s=t=>{document.querySelector("html").setAttribute("data-bs-theme",t.matches?"dark":"")};s(t),t.addEventListener("change",s),null!==saltos.token.get_token()&&saltos.authenticate.checktoken(),null===saltos.token.get_token()&&history.replaceState(null,null,".#app/login"),window.dispatchEvent(new HashChangeEvent("hashchange"))})();
