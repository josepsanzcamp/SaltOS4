...
"use strict";saltos.show_error=e=>{console.log(e),"object"==typeof e?saltos.alert("Error "+e.code,e.text):document.body.append(saltos.html(`<pre class="m-3">${e}</pre>`))},saltos.alert=(e,t)=>{var a;saltos.modal({title:e,close:"Close",body:t,footer:(a=saltos.html("<div></div>"),a.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),a)})},saltos.check_response=e=>"object"!=typeof e?(saltos.show_error(e),!1):"object"!=typeof e.error||(saltos.show_error(e.error),!1),saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{saltos.check_response(e)&&saltos.process_response(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get()}})},saltos.process_response=e=>{for(var t in e){var a=e[t];t=saltos.fix_key(t),"function"==typeof saltos.form_app[t]?saltos.form_app[t](a):(console.log("type "+t+" not found"),document.body.append(saltos.html("type "+t+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{},templates:{}},saltos.form_app.data=e=>{if(e.hasOwnProperty("#attr")&&e["#attr"].hasOwnProperty("template_id")){var t=e["#attr"].template_id;for(var a in e.value){var s=e.value[a];parseInt(a)&&saltos.form_app.layout(saltos.form_app.__layout_template_helper(t,a)),saltos.form_app.data(saltos.form_app.__data_template_helper(t,s,a))}}else for(var a in e){null==(s=e[a])&&(s="");var o=document.getElementById(a);o&&(o.value=s,"checkbox"==o.type&&(o.checked=!!s));var r=saltos.__form_app.fields.find((e=>e.id==a));void 0!==r&&(r.value=s)}},saltos.form_app.__data_template_helper=(e,t,a)=>{for(var s in t){var o=t[s];delete t[s],t[e+"#"+s+"#"+a]=o}return t},saltos.form_app.__layout_template_helper=(e,t)=>{var a=saltos.copy_object(saltos.__form_app.templates[e]),s=!0;for(var o in a["#attr"].hasOwnProperty("repeat_labels")&&"false"==a["#attr"].repeat_labels&&parseInt(t)&&(s=!1),a.value){var r=a.value[o];if(!s&&r["#attr"].hasOwnProperty("label")&&delete r["#attr"].label,r["#attr"].hasOwnProperty("id")){var l=r["#attr"].id;r["#attr"].id=e+"#"+l+"#"+t}}return a},saltos.form_app.layout=(e,t)=>{if(e.hasOwnProperty("#attr")&&e["#attr"].hasOwnProperty("template_id")){var a=e["#attr"].template_id;delete(n=saltos.copy_object(e))["#attr"].template_id,saltos.__form_app.templates[a]=n,e=saltos.form_app.__layout_template_helper(a,0)}e=saltos.form_app.__layout_auto_helper(e);var s=[];for(var o in e){var r=e[o];o=saltos.fix_key(o);var l={},p=r;if("object"==typeof r&&r.hasOwnProperty("value")&&r.hasOwnProperty("#attr")&&(l=r["#attr"],p=r.value),l.hasOwnProperty("type")||(l.type=o),"layout"==o){var i=saltos.form_app.layout({value:p,"#attr":l},"div");s.push(i)}else if(["container","col","row","div"].includes(o)){i=saltos.form_field(l);var n=saltos.form_app.layout(p,"arr");for(var d in n)i.append(n[d]);s.push(i)}else{if("object"==typeof p)for(var _ in p)l.hasOwnProperty(_)||(l[_]=p[_]);else l.hasOwnProperty("value")||(l.value=p);if(saltos.check_params(l,["id","source"]),""==l.id&&(l.id=saltos.uniqid()),saltos.__form_app.fields.push(l),""!=l.source){i=saltos.form_field({type:"placeholder",id:l.id});saltos.__source_helper(l)}else i=saltos.form_field(l);s.push(i)}}if("arr"==t)return s;var c=saltos.html("<div></div>");for(var d in s)c.append(s[d]);if(c=saltos.optimize(c),"div"==t)return c;document.body.append(c),(i=document.querySelector("[autofocus]"))&&i.focus()},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var t=e["#attr"],a=e.value;if(saltos.check_params(t,["auto","cols_per_row"]),saltos.check_params(t,["container_class","row_class","col_class"]),saltos.check_params(t,["container_style","row_style","col_style"]),""==t.cols_per_row&&(t.cols_per_row=1/0),"true"==t.auto){var s=[];for(var o in a)s.push([o,a[o]]);e={container:{value:{},"#attr":{class:t.container_class,style:t.container_style}}};for(var r=0,l=0,p=1;s.length;){var i=s.shift();p&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:t.row_class,style:t.row_style}}),l++;var n=t.col_class,d=t.col_style;i[1].hasOwnProperty("#attr")&&(i[1]["#attr"].hasOwnProperty("col_class")&&(n=i[1]["#attr"].col_class),i[1]["#attr"].hasOwnProperty("col_style")&&(d=i[1]["#attr"].col_style)),"hidden"==saltos.fix_key(i[0])&&(n="nada",d="nada"),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:n,style:d}},e.container.value["row#"+r].value["col#"+l].value[i[0]]=i[1],l>=t.cols_per_row?(l=0,p=1):p=0}}else e=a}return e},saltos.form_app.style=e=>{for(var t in e){var a=e[t];if("inline"==(t=saltos.fix_key(t))){var s=document.createElement("style");s.innerHTML=a,document.head.append(s)}"file"==t&&saltos.require(a)}},saltos.form_app.javascript=e=>{for(var t in e){var a=e[t];if("inline"==(t=saltos.fix_key(t))){var s=document.createElement("script");s.innerHTML=a,document.body.append(s)}"file"==t&&saltos.require(a)}},saltos.loading=e=>{var t=document.getElementById("loading");return e&&!t?(t=saltos.html('\n            <div id="loading" class="w-100 h-100 position-fixed top-0 start-0 opacity-75">\n                <div class="spinner-border position-fixed top-50 start-50" role="status">\n                    <span class="visually-hidden">Loading...</span>\n                </div>\n            </div>\n        '),document.querySelector("html").getAttribute("data-bs-theme")?(t.classList.add("bg-dark"),t.classList.add("text-light")):(t.classList.add("bg-light"),t.classList.add("text-dark")),document.body.append(t),!0):!(e||!t)&&(t.remove(),!0)},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:t=>{if(saltos.check_response(t)){for(var a in e.source="",t)e[a]=t[a];document.getElementById(e.id).replaceWith(saltos.form_field(e))}},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get()}})},saltos.get_data=e=>{saltos.__form_app.data={};var t=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var a in saltos.__form_app.fields){var s=saltos.__form_app.fields[a],o=document.getElementById(s.id);if(o&&t.includes(o.type)){var r=o.value;(s.value.toString()!=r||e)&&(saltos.__form_app.data[s.id]=r)}}return saltos.__form_app.data},saltos.check_required=()=>{var e=null;return document.querySelectorAll("[required]").forEach((t=>{t.classList.remove("is-valid"),t.classList.remove("is-invalid"),""==t.value?(t.classList.add("is-invalid"),e||(e=t)):t.classList.add("is-valid")})),!e||(e.focus(),!1)},saltos.form_disabled=e=>{saltos.__form_helper("disabled",e)},saltos.form_readonly=e=>{saltos.__form_helper("readonly",e)},saltos.__form_helper=(e,t)=>{var a=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var s in saltos.__form_app.fields){var o=saltos.__form_app.fields[s],r=document.getElementById(o.id);r&&a.includes(r.type)&&(t?r.setAttribute(e,""):r.removeAttribute(e))}},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),t=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};t(e),e.addEventListener("change",t),saltos.token.get()&&saltos.authenticate.checktoken(),saltos.token.get()?(["","app/login"].includes(saltos.hash.get())&&saltos.hash.set("app/dashboard"),saltos.hash.trigger()):saltos.send_request("app/login")})();
