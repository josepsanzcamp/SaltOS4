...
"use strict";saltos.show_error=e=>{var s;(console.log(e),"object"==typeof e)?saltos.modal({title:"Error "+e.code,close:"Close",body:e.text,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Accept",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),s)}):document.body.append(saltos.html(`<pre class='m-3'>${e}</pre>`))},saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{"object"==typeof e?"object"!=typeof e.error?saltos.process_response(e):saltos.show_error(e.error):saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.process_response=e=>{for(var s in e){var a=e[s];s=saltos.fix_key(s);"function"==typeof saltos.form_app[s]?saltos.form_app[s](a):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=e=>{for(var s in e){var a=e[s],o=document.getElementById(s);null!==o&&("checkbox"==o.type?o.checked=!!a:o.value=a)}},saltos.form_app.layout=(e,s)=>{e=saltos.form_app.__layout_auto_helper(e);var a=[];for(var o in e){var t=e[o];if(o=saltos.fix_key(o),"object"==typeof t&&t.hasOwnProperty("value")&&t.hasOwnProperty("#attr"))var r=t["#attr"],l=t.value;else r={},l=t;if(r.hasOwnProperty("type")||(r.type=o),"layout"==o){var n=saltos.form_app.layout({value:l,"#attr":r},"div");a.push(n)}else if(["container","col","row","div"].includes(o)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var p in c)n.append(c[p]);a.push(n)}else{if("object"==typeof l)for(var i in l)r.hasOwnProperty(i)||(r[i]=l[i]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);a.push(n)}}if("arr"==s)return a;var d=saltos.html("<div></div>");for(var p in a)d.append(a[p]);if(d=saltos.optimize(d),"div"==s)return d;document.body.append(d)},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var s=e["#attr"],a=e.value;if(saltos.check_params(s,["auto","cols_per_row"]),saltos.check_params(s,["container_class","row_class","col_class"]),saltos.check_params(s,["container_style","row_style","col_style"]),""==s.cols_per_row&&(s.cols_per_row=1/0),"true"==s.auto){var o=[];for(var t in a)o.push([t,a[t]]);e={container:{value:{},"#attr":{class:s.container_class,style:s.container_style}}};for(var r=0,l=0,n=1;o.length;){var c=o.shift(o);n&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:s.row_class,style:s.row_style}}),l++;var p=s.col_class,i=s.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(p=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(i=c[1]["#attr"].col_style)),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:p,style:i}},e.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=s.cols_per_row?(l=0,n=1):n=0}}else e=a}return e},saltos.form_app.style=e=>{for(var s in e){var a=e[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("style");o.innerHTML=a,document.head.append(o)}"file"==s&&saltos.require(a)}},saltos.form_app.javascript=e=>{for(var s in e){var a=e[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("script");o.innerHTML=a,document.body.append(o)}"file"==s&&saltos.require(a)}},window.onhashchange=e=>{var s=document.location.hash;"#"==s.substr(0,1)&&(s=s.substr(1)),""==s&&(s="app/menu",history.replaceState(null,null,".#"+s)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(1),saltos.send_request(s)},saltos.loading=e=>{var s=document.getElementById("loading");if(e&&!s)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,window.scrollMaxY),!0;if(!e&&s){window.scrollTo(0,0);var a=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(a))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:s=>{if("object"==typeof s)if("object"!=typeof s.error){for(var a in e.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)e[a]=s[a];document.getElementById(e.id).replaceWith(saltos.form_field(e))}else saltos.show_error(s.error);else saltos.show_error(s)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.get_data=e=>{if(void 0===e)e=!1;for(var s in saltos.__form_app.data={},saltos.__form_app.fields){var a=saltos.__form_app.fields[s],o=document.getElementById(a.id);if(null!==o&&["hidden","text","password","checkbox","textarea"].includes(o.type)){var t=o.value;(a.value!=t||e)&&(saltos.__form_app.data[a.id]=t)}}return saltos.__form_app.data},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),s=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};if(s(e),e.addEventListener("change",s),saltos.token=localStorage.getItem("token"),null===saltos.token){history.replaceState(null,null,".#app/login")}window.dispatchEvent(new HashChangeEvent("hashchange"))})();
