...
"use strict";saltos.show_error=e=>{var s;(console.log(e),"object"==typeof e)?saltos.modal({title:"Error "+e.code,close:"Close",body:e.text,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Accept",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),s)}):document.body.append(saltos.html(`<pre class='m-3'>${e}</pre>`))},saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{"object"==typeof e?"object"!=typeof e.error?saltos.process_response(e):saltos.show_error(e.error):saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.process_response=e=>{for(var s in e){var o=e[s];s=saltos.fix_key(s);"function"==typeof saltos.form_app[s]?saltos.form_app[s](o):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=e=>{for(var s in e){var o=e[s],a=document.getElementById(s);null!==a&&("checkbox"==a.type?a.checked=!!o:a.value=o)}},saltos.form_app.layout=(e,s)=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var o=e["#attr"],a=e.value;if(saltos.check_params(o,["auto","cols_per_row","container_class","row_class","col_class"]),""==o.cols_per_row&&(o.cols_per_row=1/0),"true"==o.auto){var t=[];for(var r in a)t.push([r,a[r]]);e={container:{value:{},"#attr":{class:o.container_class}}};for(var l=0,n=0,c=1;t.length;){var i=t.shift(t);c&&(l++,e.container.value["row#"+l]={value:{},"#attr":{class:o.row_class}}),n++;var p=o.col_class;i[1].hasOwnProperty("#attr")&&i[1]["#attr"].hasOwnProperty("col_class")&&(p=i[1]["#attr"].col_class),e.container.value["row#"+l].value["col#"+n]={value:{},"#attr":{class:p}},e.container.value["row#"+l].value["col#"+n].value[i[0]]=i[1],n>=o.cols_per_row?(n=0,c=1):c=0}}else e=a}var d=[];for(var r in e){var u=e[r];if(r=saltos.fix_key(r),"object"==typeof u&&u.hasOwnProperty("value")&&u.hasOwnProperty("#attr"))o=u["#attr"],a=u.value;else o={},a=u;if(o.hasOwnProperty("type")||(o.type=r),["container","col","row","div"].includes(r)){var f=saltos.form_field(o);t=saltos.form_app.layout(a,1);for(var _ in t)f.append(t[_]);d.push(f)}else{if("object"==typeof a)for(var v in a)o.hasOwnProperty(v)||(o[v]=a[v]);else o.hasOwnProperty("value")||(o.value=a);if(saltos.check_params(o,["id","source"]),""==o.id&&(o.id=saltos.uniqid()),saltos.__form_app.fields.push(o),""!=o.source){f=saltos.form_field({type:"placeholder",id:o.id});saltos.__source_helper(o)}else f=saltos.form_field(o);d.push(f)}}if(s)return d;var h=saltos.html("<div></div>");for(var _ in d)h.append(d[_]);h=saltos.optimize(h),document.body.append(h)},saltos.form_app.style=e=>{for(var s in e){var o=e[s];if("inline"==(s=saltos.fix_key(s))){var a=document.createElement("style");a.innerHTML=o,document.head.append(a)}"file"==s&&saltos.require(o)}},saltos.form_app.javascript=e=>{for(var s in e){var o=e[s];if("inline"==(s=saltos.fix_key(s))){var a=document.createElement("script");a.innerHTML=o,document.body.append(a)}"file"==s&&saltos.require(o)}},window.onhashchange=e=>{var s=document.location.hash;"#"==s.substr(0,1)&&(s=s.substr(1)),""==s&&(s="app/menu",history.replaceState(null,null,".#"+s)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(1),saltos.send_request(s)},saltos.loading=e=>{var s=document.getElementById("loading");if(e&&!s)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,window.scrollMaxY),!0;if(!e&&s){window.scrollTo(0,0);var o=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(o))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:s=>{if("object"==typeof s)if("object"!=typeof s.error){for(var o in e.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)e[o]=s[o];document.getElementById(e.id).replaceWith(saltos.form_field(e))}else saltos.show_error(s.error);else saltos.show_error(s)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.get_data=e=>{if(void 0===e)e=!1;for(var s in saltos.__form_app.data={},saltos.__form_app.fields){var o=saltos.__form_app.fields[s],a=document.getElementById(o.id);if(null!==a&&["hidden","text","password","checkbox","textarea"].includes(a.type)){var t=a.value;(o.value!=t||e)&&(saltos.__form_app.data[o.id]=t)}}return saltos.__form_app.data},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),s=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};if(s(e),e.addEventListener("change",s),saltos.token=localStorage.getItem("token"),null===saltos.token){history.replaceState(null,null,".#app/login")}window.dispatchEvent(new HashChangeEvent("hashchange"))})();
