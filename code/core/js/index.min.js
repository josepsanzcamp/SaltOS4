...
"use strict";saltos.show_error=s=>{var t;(console.log(s),"object"==typeof s)?saltos.modal({title:"Error "+s.code,close:"Close",body:s.text,footer:(t=saltos.html("<div></div>"),t.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),t)}):document.body.append(saltos.html(`<pre class='m-3'>${s}</pre>`))},saltos.check_response=s=>"object"!=typeof s?(saltos.show_error(s),!1):"object"!=typeof s.error||(saltos.show_error(s.error),!1),saltos.send_request=s=>{saltos.ajax({url:"index.php?"+s,success:s=>{saltos.check_response(s)&&saltos.process_response(s)},error:s=>{saltos.show_error({text:s.statusText,code:s.status})},headers:{token:saltos.token.get_token()}})},saltos.process_response=s=>{for(var t in s){var e=s[t];t=saltos.fix_key(t),"function"==typeof saltos.form_app[t]?saltos.form_app[t](e):(console.log("type "+t+" not found"),document.body.append(saltos.html("type "+t+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=s=>{for(var t in s){var e=s[t],o=document.getElementById(t);null!==o&&("checkbox"==o.type?o.checked=!!e:o.value=e)}},saltos.form_app.layout=(s,t)=>{s=saltos.form_app.__layout_auto_helper(s);var e=[];for(var o in s){var a=s[o];o=saltos.fix_key(o);var r={},l=a;if("object"==typeof a&&a.hasOwnProperty("value")&&a.hasOwnProperty("#attr")&&(r=a["#attr"],l=a.value),r.hasOwnProperty("type")||(r.type=o),"layout"==o){var n=saltos.form_app.layout({value:l,"#attr":r},"div");e.push(n)}else if(["container","col","row","div"].includes(o)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var p in c)n.append(c[p]);e.push(n)}else{if("object"==typeof l)for(var i in l)r.hasOwnProperty(i)||(r[i]=l[i]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);e.push(n)}}if("arr"==t)return e;var u=saltos.html("<div></div>");for(var p in e)u.append(e[p]);if(u=saltos.optimize(u),"div"==t)return u;document.body.append(u)},saltos.form_app.__layout_auto_helper=s=>{if(s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")){var t=s["#attr"],e=s.value;if(saltos.check_params(t,["auto","cols_per_row"]),saltos.check_params(t,["container_class","row_class","col_class"]),saltos.check_params(t,["container_style","row_style","col_style"]),""==t.cols_per_row&&(t.cols_per_row=1/0),"true"==t.auto){var o=[];for(var a in e)o.push([a,e[a]]);s={container:{value:{},"#attr":{class:t.container_class,style:t.container_style}}};for(var r=0,l=0,n=1;o.length;){var c=o.shift();n&&(r++,s.container.value["row#"+r]={value:{},"#attr":{class:t.row_class,style:t.row_style}}),l++;var p=t.col_class,i=t.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(p=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(i=c[1]["#attr"].col_style)),s.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:p,style:i}},s.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=t.cols_per_row?(l=0,n=1):n=0}}else s=e}return s},saltos.form_app.style=s=>{for(var t in s){var e=s[t];if("inline"==(t=saltos.fix_key(t))){var o=document.createElement("style");o.innerHTML=e,document.head.append(o)}"file"==t&&saltos.require(e)}},saltos.form_app.javascript=s=>{for(var t in s){var e=s[t];if("inline"==(t=saltos.fix_key(t))){var o=document.createElement("script");o.innerHTML=e,document.body.append(o)}"file"==t&&saltos.require(e)}},window.onhashchange=s=>{""!=saltos.hash.get()&&(saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(!0),saltos.send_request(saltos.hash.get()))},saltos.hash={},saltos.hash.get=()=>{var s=document.location.hash;return"#"==s.substr(0,1)&&(s=s.substr(1)),s},saltos.hash.set=s=>{"#"!=s.substr(0,1)&&(s="#"+s),history.replaceState(null,null,s)},saltos.hash.change=()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))},saltos.loading=s=>{var t=document.getElementById("loading");if(s&&!t)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,1<<30),!0;if(!s&&t){window.scrollTo(0,0);var e=setInterval((()=>{0==window.scrollY&&(t.remove(),clearInterval(e))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=s=>{saltos.check_params(s,["id","source"]),""!=s.source&&saltos.ajax({url:"index.php?"+s.source,success:t=>{if(saltos.check_response(t)){for(var e in s.source="",t.hasOwnProperty("value")&&t.hasOwnProperty("#attr")&&(t=t.value),t)s[e]=t[e];document.getElementById(s.id).replaceWith(saltos.form_field(s))}},error:s=>{saltos.show_error({text:s.statusText,code:s.status})},headers:{token:saltos.token.get_token()}})},saltos.get_data=s=>{for(var t in saltos.__form_app.data={},saltos.__form_app.fields){var e=saltos.__form_app.fields[t],o=document.getElementById(e.id);if(null!==o&&["hidden","text","password","checkbox","textarea"].includes(o.type)){var a=o.value;(e.value!=a||s)&&(saltos.__form_app.data[e.id]=a)}}return saltos.__form_app.data},saltos.token={},saltos.token.get_token=()=>localStorage.getItem("saltos.token"),saltos.token.get_expires=()=>localStorage.getItem("saltos.expires"),saltos.token.set=(s,t)=>{localStorage.setItem("saltos.token",s),localStorage.setItem("saltos.expires",t)},saltos.token.unset=()=>{localStorage.removeItem("saltos.token"),localStorage.removeItem("saltos.expires")},saltos.authenticate={},saltos.authenticate.authtoken=(s,t)=>{saltos.ajax({url:"index.php",data:JSON.stringify({user:s,pass:t,action:"authtoken"}),method:"post",content_type:"application/json",async:!1,success:s=>{saltos.check_response(s)&&("ok"!=s.status?"ko"!=s.status?saltos.show_error(s):saltos.token.unset():saltos.token.set(s.token,s.expires_at))},error:s=>{saltos.show_error({text:s.statusText,code:s.status})}})},saltos.authenticate.reauthtoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"reauthtoken"}),method:"post",content_type:"application/json",async:!1,success:s=>{saltos.check_response(s)&&("ok"!=s.status?"ko"!=s.status?saltos.show_error(s):saltos.token.unset():saltos.token.set(s.token,s.expires_at))},error:s=>{saltos.show_error({text:s.statusText,code:s.status})},headers:{token:saltos.token.get_token()}})},saltos.authenticate.deauthtoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"deauthtoken"}),method:"post",content_type:"application/json",async:!1,success:s=>{saltos.check_response(s)&&("ok"!=s.status&&"ko"!=s.status?saltos.show_error(s):saltos.token.unset())},error:s=>{saltos.show_error({text:s.statusText,code:s.status})},headers:{token:saltos.token.get_token()}})},saltos.authenticate.checktoken=()=>{saltos.ajax({url:"index.php",data:JSON.stringify({action:"checktoken"}),method:"post",content_type:"application/json",async:!1,success:s=>{saltos.check_response(s)&&("ok"!=s.status?"ko"!=s.status?saltos.show_error(s):saltos.token.unset():saltos.token.set(s.token,s.expires_at))},error:s=>{saltos.show_error({text:s.statusText,code:s.status})},headers:{token:saltos.token.get_token()}})},(()=>{var s=window.matchMedia("(prefers-color-scheme: dark)"),t=s=>{document.querySelector("html").setAttribute("data-bs-theme",s.matches?"dark":"")};t(s),s.addEventListener("change",t),null!==saltos.token.get_token()&&saltos.authenticate.checktoken(),null===saltos.token.get_token()&&saltos.hash.set("app/login"),""==saltos.hash.get()&&saltos.hash.set("app/menu"),saltos.hash.change()})();
