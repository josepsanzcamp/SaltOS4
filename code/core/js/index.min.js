...
"use strict";saltos.show_error=e=>{console.log(e),"object"==typeof e?saltos.alert("Error "+e.code,e.text):document.body.append(saltos.html(`<pre class='m-3'>${e}</pre>`))},saltos.alert=(e,s)=>{var a;saltos.modal({title:e,close:"Close",body:s,footer:(a=saltos.html("<div></div>"),a.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),a)})},saltos.check_response=e=>"object"!=typeof e?(saltos.show_error(e),!1):"object"!=typeof e.error||(saltos.show_error(e.error),!1),saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{saltos.check_response(e)&&saltos.process_response(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get_token()}})},saltos.process_response=e=>{for(var s in e){var a=e[s];s=saltos.fix_key(s),"function"==typeof saltos.form_app[s]?saltos.form_app[s](a):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=e=>{for(var s in e){var a=e[s],t=document.getElementById(s);null!==t&&(t.value=a,"checkbox"==t.type&&(t.checked=!!a));var o=saltos.__form_app.fields.find((e=>e.id==s));void 0!==o&&(o.value=a)}},saltos.form_app.layout=(e,s)=>{e=saltos.form_app.__layout_auto_helper(e);var a=[];for(var t in e){var o=e[t];t=saltos.fix_key(t);var r={},l=o;if("object"==typeof o&&o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")&&(r=o["#attr"],l=o.value),r.hasOwnProperty("type")||(r.type=t),"layout"==t){var n=saltos.form_app.layout({value:l,"#attr":r},"div");a.push(n)}else if(["container","col","row","div"].includes(t)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var i in c)n.append(c[i]);a.push(n)}else{if("object"==typeof l)for(var d in l)r.hasOwnProperty(d)||(r[d]=l[d]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);a.push(n)}}if("arr"==s)return a;var p=saltos.html("<div></div>");for(var i in a)p.append(a[i]);if(p=saltos.optimize(p),"div"==s)return p;document.body.append(p)},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var s=e["#attr"],a=e.value;if(saltos.check_params(s,["auto","cols_per_row"]),saltos.check_params(s,["container_class","row_class","col_class"]),saltos.check_params(s,["container_style","row_style","col_style"]),""==s.cols_per_row&&(s.cols_per_row=1/0),"true"==s.auto){var t=[];for(var o in a)t.push([o,a[o]]);e={container:{value:{},"#attr":{class:s.container_class,style:s.container_style}}};for(var r=0,l=0,n=1;t.length;){var c=t.shift();n&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:s.row_class,style:s.row_style}}),l++;var i=s.col_class,d=s.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(i=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(d=c[1]["#attr"].col_style)),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:i,style:d}},e.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=s.cols_per_row?(l=0,n=1):n=0}}else e=a}return e},saltos.form_app.style=e=>{for(var s in e){var a=e[s];if("inline"==(s=saltos.fix_key(s))){var t=document.createElement("style");t.innerHTML=a,document.head.append(t)}"file"==s&&saltos.require(a)}},saltos.form_app.javascript=e=>{for(var s in e){var a=e[s];if("inline"==(s=saltos.fix_key(s))){var t=document.createElement("script");t.innerHTML=a,document.body.append(t)}"file"==s&&saltos.require(a)}},saltos.loading=e=>{var s=document.getElementById("loading");if(e&&!s)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,1<<30),!0;if(!e&&s){window.scrollTo(0,0);var a=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(a))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:s=>{if(saltos.check_response(s)){for(var a in e.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)e[a]=s[a];document.getElementById(e.id).replaceWith(saltos.form_field(e))}},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get_token()}})},saltos.get_data=e=>{saltos.__form_app.data={};var s=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var a in saltos.__form_app.fields){var t=saltos.__form_app.fields[a],o=document.getElementById(t.id);if(null!==o&&s.includes(o.type)){var r=o.value;(t.value.toString()!=r||e)&&(saltos.__form_app.data[t.id]=r)}}return saltos.__form_app.data},saltos.check_required=()=>{var e=null;return document.querySelectorAll("[required]").forEach((s=>{s.classList.remove("is-valid"),s.classList.remove("is-invalid"),""==s.value?(s.classList.add("is-invalid"),null===e&&(e=s)):s.classList.add("is-valid")})),null===e||(e.focus(),!1)},saltos.form_disabled=e=>{saltos.form_helper("disabled",e)},saltos.form_readonly=e=>{saltos.form_helper("readonly",e)},saltos.form_helper=(e,s)=>{var a=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var t in saltos.__form_app.fields){var o=saltos.__form_app.fields[t],r=document.getElementById(o.id);null!==r&&a.includes(r.type)&&(s?r.setAttribute(e,""):r.removeAttribute(e))}},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),s=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};s(e),e.addEventListener("change",s),null!==saltos.token.get_token()&&saltos.authenticate.checktoken(),saltos.authenticate.checkrenew(),setInterval(saltos.authenticate.checkrenew,6e4),""==saltos.hash.get()&&saltos.hash.set("app/menu"),null===saltos.token.get_token()?saltos.hash.set("app/login"):"app/login"==saltos.hash.get()&&saltos.hash.set("app/menu"),saltos.hash.change()})();
