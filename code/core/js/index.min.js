...
"use strict";saltos.show_error=e=>{var o;(console.log(e),"object"==typeof e)?saltos.modal({title:"Error "+e.code,close:"Close",body:e.text,footer:(o=saltos.html("<div></div>"),o.append(saltos.form_field({type:"button",value:"Accept",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),o)}):document.body.append(saltos.html(`<pre class='m-3'>${e}</pre>`))},saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{"object"==typeof e?"object"!=typeof e.error?saltos.process_response(e):saltos.show_error(e.error):saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.process_response=e=>{for(var o in e){var t=e[o];o=saltos.fix_key(o);"function"==typeof saltos.form_app[o]?saltos.form_app[o](t):(console.log("type "+o+" not found"),document.body.append(saltos.html("type "+o+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=e=>{for(var o in e){var t=e[o],s=document.getElementById(o);null!==s&&("checkbox"==s.type?s.checked=!!t:s.value=t)}},saltos.form_app.layout=(e,o)=>{e=saltos.form_app.__layout_auto_helper(e);var t=[];for(var s in e){var a=e[s];if(s=saltos.fix_key(s),"object"==typeof a&&a.hasOwnProperty("value")&&a.hasOwnProperty("#attr"))var r=a["#attr"],l=a.value;else r={},l=a;if(r.hasOwnProperty("type")||(r.type=s),"layout"==s){var n=saltos.form_app.layout({value:l,"#attr":r},"div");t.push(n)}else if(["container","col","row","div"].includes(s)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var i in c)n.append(c[i]);t.push(n)}else{if("object"==typeof l)for(var p in l)r.hasOwnProperty(p)||(r[p]=l[p]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);t.push(n)}}if("arr"==o)return t;var d=saltos.html("<div></div>");for(var i in t)d.append(t[i]);if(d=saltos.optimize(d),"div"==o)return d;document.body.append(d)},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var o=e["#attr"],t=e.value;if(saltos.check_params(o,["auto","cols_per_row"]),saltos.check_params(o,["container_class","row_class","col_class"]),saltos.check_params(o,["container_style","row_style","col_style"]),""==o.cols_per_row&&(o.cols_per_row=1/0),"true"==o.auto){var s=[];for(var a in t)s.push([a,t[a]]);e={container:{value:{},"#attr":{class:o.container_class,style:o.container_style}}};for(var r=0,l=0,n=1;s.length;){var c=s.shift(s);n&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:o.row_class,style:o.row_style}}),l++;var i=o.col_class,p=o.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(i=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(p=c[1]["#attr"].col_style)),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:i,style:p}},e.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=o.cols_per_row?(l=0,n=1):n=0}}else e=t}return e},saltos.form_app.style=e=>{for(var o in e){var t=e[o];if("inline"==(o=saltos.fix_key(o))){var s=document.createElement("style");s.innerHTML=t,document.head.append(s)}"file"==o&&saltos.require(t)}},saltos.form_app.javascript=e=>{for(var o in e){var t=e[o];if("inline"==(o=saltos.fix_key(o))){var s=document.createElement("script");s.innerHTML=t,document.body.append(s)}"file"==o&&saltos.require(t)}},window.onhashchange=e=>{var o=document.location.hash;"#"==o.substr(0,1)&&(o=o.substr(1)),""==o&&(o="app/menu",history.replaceState(null,null,".#"+o)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(1),saltos.send_request(o)},saltos.loading=e=>{var o=document.getElementById("loading");if(e&&!o)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,window.scrollMaxY),!0;if(!e&&o){window.scrollTo(0,0);var t=setInterval((()=>{0==window.scrollY&&(o.remove(),clearInterval(t))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:o=>{if("object"==typeof o)if("object"!=typeof o.error){for(var t in e.source="",o.hasOwnProperty("value")&&o.hasOwnProperty("#attr")&&(o=o.value),o)e[t]=o[t];document.getElementById(e.id).replaceWith(saltos.form_field(e))}else saltos.show_error(o.error);else saltos.show_error(o)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.get_data=e=>{for(var o in saltos.__form_app.data={},saltos.__form_app.fields){var t=saltos.__form_app.fields[o],s=document.getElementById(t.id);if(null!==s&&["hidden","text","password","checkbox","textarea"].includes(s.type)){var a=s.value;(t.value!=a||e)&&(saltos.__form_app.data[t.id]=a)}}return saltos.__form_app.data},saltos.authenticate=(e,o)=>{saltos.ajax({url:"index.php",data:JSON.stringify({user:e,pass:o,action:"authtoken"}),method:"post",content_type:"application/json",async:!1,success:e=>{if("object"==typeof e)return"object"==typeof e.error?(localStorage.removeItem("token"),void(saltos.token=null)):"ok"==e.status&&e.token?(localStorage.setItem("token",e.token),void(saltos.token=e.token)):void saltos.show_error(e);saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})}})},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),o=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};if(o(e),e.addEventListener("change",o),saltos.token=localStorage.getItem("token"),null!==saltos.token)saltos.ajax({url:"index.php",data:JSON.stringify({action:"checktoken"}),method:"post",content_type:"application/json",async:!1,success:e=>{if("object"==typeof e)return"object"==typeof e.error?(localStorage.removeItem("token"),void(saltos.token=null)):"ok"==e.status?(localStorage.setItem("token",e.token),void(saltos.token=e.token)):void 0;saltos.show_error(e)},error:e=>{localStorage.removeItem("token"),saltos.token=null,saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}});null===saltos.token&&history.replaceState(null,null,".#app/login"),window.dispatchEvent(new HashChangeEvent("hashchange"))})();
