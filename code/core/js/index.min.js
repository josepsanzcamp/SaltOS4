...
"use strict";saltos.show_error=e=>{console.log(e),"object"==typeof e?saltos.alert("Error "+e.code,e.text):document.body.append(saltos.html(`<pre class="m-3">${e}</pre>`))},saltos.alert=(e,a)=>{var t;saltos.modal({title:e,close:"Close",body:a,footer:(t=saltos.html("<div></div>"),t.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),t)})},saltos.check_response=e=>"object"!=typeof e?(saltos.show_error(e),!1):"object"!=typeof e.error||(saltos.show_error(e.error),!1),saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{saltos.check_response(e)&&saltos.process_response(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get()}})},saltos.process_response=e=>{for(var a in e){var t=e[a];a=saltos.fix_key(a),"function"==typeof saltos.form_app[a]?saltos.form_app[a](t):(console.log("type "+a+" not found"),document.body.append(saltos.html("type "+a+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{},templates:{}},saltos.form_app.data=e=>{if(e.hasOwnProperty("#attr")&&e["#attr"].hasOwnProperty("template_id")){var a=e["#attr"].template_id;if(!Array.isArray(e.value))return void console.log("data for template "+a+" is not an array of rows");for(var t in e.value){var s=e.value[t];parseInt(t)&&saltos.form_app.layout(saltos.form_app.__layout_template_helper(a,t)),saltos.form_app.data(saltos.form_app.__data_template_helper(a,s,t))}}else if(Array.isArray(e))console.log("data is an array instead of an object of key and val pairs");else for(var t in e){null==(s=e[t])&&(s="");var o=document.getElementById(t);o&&(o.value=s,"checkbox"==o.type&&(o.checked=!!s));var r=saltos.__form_app.fields.find((e=>e.id==t));void 0!==r&&(r.value=s)}},saltos.form_app.__data_template_helper=(e,a,t)=>{for(var s in a){var o=a[s];delete a[s],a[e+"#"+s+"#"+t]=o}return a},saltos.form_app.__layout_template_helper=(e,a)=>{var t=saltos.copy_object(saltos.__form_app.templates[e]),s=!0;for(var o in t["#attr"].hasOwnProperty("repeat_labels")&&"false"==t["#attr"].repeat_labels&&parseInt(a)&&(s=!1),t.value){var r=t.value[o];if(!s&&r["#attr"].hasOwnProperty("label")&&delete r["#attr"].label,r["#attr"].hasOwnProperty("id")){var l=r["#attr"].id;r["#attr"].id=e+"#"+l+"#"+a}}return t},saltos.form_app.layout=(e,a)=>{if(e.hasOwnProperty("#attr")&&e["#attr"].hasOwnProperty("template_id")){var t=e["#attr"].template_id;delete(n=saltos.copy_object(e))["#attr"].template_id,saltos.__form_app.templates[t]=n,e=saltos.form_app.__layout_template_helper(t,0)}e=saltos.form_app.__layout_auto_helper(e);var s=[];for(var o in e){var r=e[o];o=saltos.fix_key(o);var l={},p=r;if("object"==typeof r&&r.hasOwnProperty("value")&&r.hasOwnProperty("#attr")&&(l=r["#attr"],p=r.value),l.hasOwnProperty("type")||(l.type=o),"layout"==o){var i=saltos.form_app.layout({value:p,"#attr":l},"div");s.push(i)}else if(["container","col","row","div"].includes(o)){i=saltos.form_field(l);var n=saltos.form_app.layout(p,"arr");for(var d in n)i.append(n[d]);s.push(i)}else{if("object"==typeof p)for(var _ in p)l.hasOwnProperty(_)||(l[_]=p[_]);else l.hasOwnProperty("value")||(l.value=p);if(saltos.check_params(l,["id","source"]),""==l.id&&(l.id=saltos.uniqid()),saltos.__form_app.fields.push(l),""!=l.source){i=saltos.form_field({type:"placeholder",id:l.id});saltos.__source_helper(l)}else i=saltos.form_field(l);s.push(i)}}if("arr"==a)return s;var c=saltos.html("<div></div>");for(var d in s)c.append(s[d]);if(c=saltos.optimize(c),"div"==a)return c;document.body.append(c),(i=document.querySelector("[autofocus]"))&&i.focus()},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var a=e["#attr"],t=e.value;if(saltos.check_params(a,["auto","cols_per_row"]),saltos.check_params(a,["container_class","row_class","col_class"]),saltos.check_params(a,["container_style","row_style","col_style"]),""==a.cols_per_row&&(a.cols_per_row=1/0),"true"==a.auto){var s=[];for(var o in t)s.push([o,t[o]]);e={container:{value:{},"#attr":{class:a.container_class,style:a.container_style}}};for(var r=0,l=0,p=1;s.length;){var i=s.shift();p&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:a.row_class,style:a.row_style}}),l++;var n=a.col_class,d=a.col_style;i[1].hasOwnProperty("#attr")&&(i[1]["#attr"].hasOwnProperty("col_class")&&(n=i[1]["#attr"].col_class),i[1]["#attr"].hasOwnProperty("col_style")&&(d=i[1]["#attr"].col_style)),"hidden"==saltos.fix_key(i[0])&&(n="d-none",d=""),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:n,style:d}},e.container.value["row#"+r].value["col#"+l].value[i[0]]=i[1],l>=a.cols_per_row?(l=0,p=1):p=0}}else e=t}return e},saltos.form_app.style=e=>{for(var a in e){var t=e[a];if("inline"==(a=saltos.fix_key(a))){var s=document.createElement("style");s.innerHTML=t,document.head.append(s)}"file"==a&&saltos.require(t)}},saltos.form_app.javascript=e=>{for(var a in e){var t=e[a];if("inline"==(a=saltos.fix_key(a))){var s=document.createElement("script");s.innerHTML=t,document.body.append(s)}"file"==a&&saltos.require(t)}},saltos.loading=e=>{var a=document.getElementById("loading");return e&&!a?(a=saltos.html('\n            <div id="loading" class="w-100 h-100 position-fixed top-0 start-0 opacity-75">\n                <div class="spinner-border position-fixed top-50 start-50" role="status">\n                    <span class="visually-hidden">Loading...</span>\n                </div>\n            </div>\n        '),document.querySelector("html").getAttribute("data-bs-theme")?(a.classList.add("bg-dark"),a.classList.add("text-light")):(a.classList.add("bg-light"),a.classList.add("text-dark")),document.body.append(a),!0):!(e||!a)&&(a.remove(),!0)},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:a=>{if(saltos.check_response(a)){for(var t in e.source="",a)e[t]=a[t];document.getElementById(e.id).replaceWith(saltos.form_field(e))}},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token.get()}})},saltos.get_data=e=>{saltos.__form_app.data={};var a=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var t in saltos.__form_app.fields){var s=saltos.__form_app.fields[t];if(!s.hasOwnProperty("ignore")||"true"!=s.ignore)if(r=document.getElementById(s.id))if(a.includes(r.type))((p=str_replace(["\r\n","\r"],"\n",r.value))!=str_replace(["\r\n","\r"],"\n",s.value.toString())||e)&&(saltos.__form_app.data[s.id]=p)}for(var o in saltos.__form_app.data){var r,l=o.split("#");if(3==l.length&&"id"!=l[1])if(l[1]="id",l=l.join("#"),!saltos.__form_app.data.hasOwnProperty(l))if(r=document.getElementById(l)){var p=r.value;saltos.__form_app.data[l]=p}}return saltos.__form_app.data},saltos.check_required=()=>{var e=null;return document.querySelectorAll("[required]").forEach((a=>{a.classList.remove("is-valid"),a.classList.remove("is-invalid"),""==a.value?(a.classList.add("is-invalid"),e||(e=a)):a.classList.add("is-valid")})),!e||(e.focus(),!1)},saltos.form_disabled=e=>{saltos.__form_helper("disabled",e)},saltos.form_readonly=e=>{saltos.__form_helper("readonly",e)},saltos.__form_helper=(e,a)=>{var t=["text","color","date","time","datetime-local","hidden","textarea","checkbox","password","file","select-one"];for(var s in saltos.__form_app.fields){var o=saltos.__form_app.fields[s],r=document.getElementById(o.id);r&&t.includes(r.type)&&(a?r.setAttribute(e,""):r.removeAttribute(e))}},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),a=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};a(e),e.addEventListener("change",a),saltos.token.get()&&saltos.authenticate.checktoken(),saltos.token.get()?(["","app/login"].includes(saltos.hash.get())&&saltos.hash.set("app/dashboard"),saltos.hash.trigger()):saltos.send_request("app/login")})();
