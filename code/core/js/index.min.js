...
"use strict";window.onhashchange=s=>{saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(!0),saltos.send_request(saltos.hash.get())},saltos.hash={},saltos.hash.get=()=>{var s=document.location.hash;return"#"==s.substr(0,1)&&(s=s.substr(1)),s},saltos.hash.replace=s=>{"#"!=s.substr(0,1)&&(s="#"+s),history.replaceState(null,null,s)},saltos.hash.add=s=>{"#"!=s.substr(0,1)&&(s="#"+s),history.pushState(null,null,s)},saltos.hash.change=()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))};
