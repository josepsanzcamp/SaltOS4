...
"use strict";saltos.show_error=e=>{var s;(console.log(e),"object"==typeof e)?saltos.modal({title:"Error "+e.code,close:"Close",body:e.text,footer:(s=saltos.html("<div></div>"),s.append(saltos.form_field({type:"button",value:"Close",class:"btn-primary",onclick:()=>{saltos.modal("close")}})),s)}):document.body.append(saltos.html(`<pre class='m-3'>${e}</pre>`))},saltos.check_response=e=>"object"!=typeof e?(saltos.show_error(e),!1):"object"!=typeof e.error||(saltos.show_error(e.error),!1),saltos.send_request=e=>{saltos.ajax({url:"index.php?"+e,success:e=>{saltos.check_response(e)&&saltos.process_response(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.process_response=e=>{for(var s in e){var t=e[s];s=saltos.fix_key(s),"function"==typeof saltos.form_app[s]?saltos.form_app[s](t):(console.log("type "+s+" not found"),document.body.append(saltos.html("type "+s+" not found")))}},saltos.form_app={},saltos.__form_app={fields:[],data:{}},saltos.form_app.data=e=>{for(var s in e){var t=e[s],o=document.getElementById(s);null!==o&&("checkbox"==o.type?o.checked=!!t:o.value=t)}},saltos.form_app.layout=(e,s)=>{e=saltos.form_app.__layout_auto_helper(e);var t=[];for(var o in e){var a=e[o];o=saltos.fix_key(o);var r={},l=a;if("object"==typeof a&&a.hasOwnProperty("value")&&a.hasOwnProperty("#attr")&&(r=a["#attr"],l=a.value),r.hasOwnProperty("type")||(r.type=o),"layout"==o){var n=saltos.form_app.layout({value:l,"#attr":r},"div");t.push(n)}else if(["container","col","row","div"].includes(o)){n=saltos.form_field(r);var c=saltos.form_app.layout(l,"arr");for(var i in c)n.append(c[i]);t.push(n)}else{if("object"==typeof l)for(var p in l)r.hasOwnProperty(p)||(r[p]=l[p]);else r.hasOwnProperty("value")||(r.value=l);if(saltos.check_params(r,["id","source"]),""==r.id&&(r.id=saltos.uniqid()),saltos.__form_app.fields.push(r),""!=r.source){n=saltos.form_field({type:"placeholder",id:r.id});saltos.__source_helper(r)}else n=saltos.form_field(r);t.push(n)}}if("arr"==s)return t;var d=saltos.html("<div></div>");for(var i in t)d.append(t[i]);if(d=saltos.optimize(d),"div"==s)return d;document.body.append(d)},saltos.form_app.__layout_auto_helper=e=>{if(e.hasOwnProperty("value")&&e.hasOwnProperty("#attr")){var s=e["#attr"],t=e.value;if(saltos.check_params(s,["auto","cols_per_row"]),saltos.check_params(s,["container_class","row_class","col_class"]),saltos.check_params(s,["container_style","row_style","col_style"]),""==s.cols_per_row&&(s.cols_per_row=1/0),"true"==s.auto){var o=[];for(var a in t)o.push([a,t[a]]);e={container:{value:{},"#attr":{class:s.container_class,style:s.container_style}}};for(var r=0,l=0,n=1;o.length;){var c=o.shift();n&&(r++,e.container.value["row#"+r]={value:{},"#attr":{class:s.row_class,style:s.row_style}}),l++;var i=s.col_class,p=s.col_style;c[1].hasOwnProperty("#attr")&&(c[1]["#attr"].hasOwnProperty("col_class")&&(i=c[1]["#attr"].col_class),c[1]["#attr"].hasOwnProperty("col_style")&&(p=c[1]["#attr"].col_style)),e.container.value["row#"+r].value["col#"+l]={value:{},"#attr":{class:i,style:p}},e.container.value["row#"+r].value["col#"+l].value[c[0]]=c[1],l>=s.cols_per_row?(l=0,n=1):n=0}}else e=t}return e},saltos.form_app.style=e=>{for(var s in e){var t=e[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("style");o.innerHTML=t,document.head.append(o)}"file"==s&&saltos.require(t)}},saltos.form_app.javascript=e=>{for(var s in e){var t=e[s];if("inline"==(s=saltos.fix_key(s))){var o=document.createElement("script");o.innerHTML=t,document.body.append(o)}"file"==s&&saltos.require(t)}},window.onhashchange=e=>{var s=document.location.hash;"#"==s.substr(0,1)&&(s=s.substr(1)),""==s&&(s="app/menu",history.replaceState(null,null,".#"+s)),saltos.modal("close"),saltos.offcanvas("close"),saltos.loading(1),saltos.send_request(s)},saltos.loading=e=>{var s=document.getElementById("loading");if(e&&!s)return document.body.append(saltos.html("\n            <div id='loading' class='d-flex justify-content-center align-items-center vh-100'>\n                <div class='spinner-border' role='status'>\n                    <span class='visually-hidden'>Loading...</span>\n                </div>\n            </div>\n        ")),window.scrollTo(0,1<<30),!0;if(!e&&s){window.scrollTo(0,0);var t=setInterval((()=>{0==window.scrollY&&(s.remove(),clearInterval(t))}),1);return!0}return!1},saltos.clear_screen=()=>{document.body.innerHTML=""},saltos.__source_helper=e=>{saltos.check_params(e,["id","source"]),""!=e.source&&saltos.ajax({url:"index.php?"+e.source,success:s=>{if(saltos.check_response(s)){for(var t in e.source="",s.hasOwnProperty("value")&&s.hasOwnProperty("#attr")&&(s=s.value),s)e[t]=s[t];document.getElementById(e.id).replaceWith(saltos.form_field(e))}},error:e=>{saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}})},saltos.get_data=e=>{for(var s in saltos.__form_app.data={},saltos.__form_app.fields){var t=saltos.__form_app.fields[s],o=document.getElementById(t.id);if(null!==o&&["hidden","text","password","checkbox","textarea"].includes(o.type)){var a=o.value;(t.value!=a||e)&&(saltos.__form_app.data[t.id]=a)}}return saltos.__form_app.data},saltos.authenticate=(e,s)=>{saltos.ajax({url:"index.php",data:JSON.stringify({user:e,pass:s,action:"authtoken"}),method:"post",content_type:"application/json",async:!1,success:e=>{if(saltos.check_response(e))return"ok"==e.status&&e.token?(localStorage.setItem("token",e.token),void(saltos.token=e.token)):"ko"==e.status?(localStorage.removeItem("token"),void(saltos.token=null)):void saltos.show_error(e)},error:e=>{saltos.show_error({text:e.statusText,code:e.status})}})},(()=>{var e=window.matchMedia("(prefers-color-scheme: dark)"),s=e=>{document.querySelector("html").setAttribute("data-bs-theme",e.matches?"dark":"")};if(s(e),e.addEventListener("change",s),saltos.token=localStorage.getItem("token"),null!==saltos.token)saltos.ajax({url:"index.php",data:JSON.stringify({action:"checktoken"}),method:"post",content_type:"application/json",async:!1,success:e=>{if(saltos.check_response(e))return"ok"==e.status&&e.token?(localStorage.setItem("token",e.token),void(saltos.token=e.token)):"ko"==e.status?(localStorage.removeItem("token"),void(saltos.token=null)):void saltos.show_error(e)},error:e=>{localStorage.removeItem("token"),saltos.token=null,saltos.show_error({text:e.statusText,code:e.status})},headers:{token:saltos.token}});null===saltos.token&&history.replaceState(null,null,".#app/login"),window.dispatchEvent(new HashChangeEvent("hashchange"))})();
