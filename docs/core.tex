...
\item[\color{myblue}$\bullet$] @l =$>$ error correction: L (low), M (medium), Q (better), H (best)
\end{compactitem}
...
\item[\color{myblue}$\bullet$] @reg\_id =$>$ register of the app where you want to add the log
