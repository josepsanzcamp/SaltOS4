...
\begin{lstlisting}
api/php/autoload/arrayutils.php
\end{lstlisting}
...
\begin{lstlisting}
api/php/autoload/colorutils.php
\end{lstlisting}
...
\begin{lstlisting}
api/php/autoload/fileutils.php
\end{lstlisting}
...
to be used by the saltos.form\_app.layout function.
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/imaskjs/imask.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/autoheight/autoheight.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/ckeditor/ckeditor.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/codemirror/codemirror.min.css
\item[\color{myblue}$\bullet$] @web/lib/codemirror/codemirror.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/handsontable/handsontable.full.min.css
\item[\color{myblue}$\bullet$] @web/lib/handsontable/handsontable.full.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/pdfjs/pdf\_viewer.min.css,
\item[\color{myblue}$\bullet$] @web/lib/pdfjs/pdf.min.mjs
\item[\color{myblue}$\bullet$] @web/lib/pdfjs/pdf\_viewer.min.mjs
\item[\color{myblue}$\bullet$] @web/lib/pdfjs/pdf.worker.min.mjs
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/chartjs/chart.umd.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/venobox/venobox.min.css
\item[\color{myblue}$\bullet$] @web/lib/venobox/venobox.min.js
\item[\color{myblue}$\bullet$] @web/lib/masonry/masonry.pkgd.min.js
\item[\color{myblue}$\bullet$] @web/lib/imagesloaded/imagesloaded.pkgd.min.js
\end{compactitem}
...
\begin{compactitem}
\item[\color{myblue}$\bullet$] @web/lib/md5/md5.min.js
\end{compactitem}
