...
final class test_cli_customers extends TestCase
{
    ...
    public function test_list(array $json): array
    {
        ...
        $json2 = test_cli_helper("list/customers/widget/utest1", "", $json["token"], "");
        $this->assertArrayHasKey("data", $json2);

        $json2 = test_cli_helper("list/customers/widget/utest2", "", $json["token"], "");
        $this->assertArrayHasKey("data", $json2);

        $json2 = test_cli_helper("list/customers", "", $json["token"], "");
        $this->assertArrayHasKey("data", $json2);
