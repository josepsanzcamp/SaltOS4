...
web: clean
	...
	cat code/web/lib/bootstrap/bootstrap.bundle.min.js code/web/lib/md5/md5.min.js code/web/lib/sourcemap/sourcemapped-stacktrace.min.js code/web/lib/interactjs/interact.min.js > code/web/lib/index.js
...
devel: clean
	...
	php scripts/debug.php lib/index.js lib/bootstrap/bootstrap.bundle.min.js lib/md5/md5.min.js lib/sourcemap/sourcemapped-stacktrace.min.js lib/interactjs/interact.min.js | \
